...
<head>
    ...
    <title>Jual/Beli Sapi - Akun </title>
...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Jualan -->
            <li class="nav-item active">
                <a class="nav-link" href="jualan.php">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 text-center">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <a href="jualSapi.php">
                                        <i class="fas fa-plus fa-5x" style="color: rgb(0, 59, 236);"></i>
                                    </a>
                                    <div class="mt-2 font-weight-bold text-center ">Jual Sapi</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 text-center">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <i class="fas fa-phone-alt fa-5x" style="color: rgb(0, 59, 236);"></i>
                                    <div class="mt-2 font-weight-bold text-center ">Pelanggan</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 text-center">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <a href="jualan.php">
                                        <i class="fas fa-shopping-cart fa-5x" style="color: rgb(0, 59, 236);"></i>
                                    </a>
                                    <div class="mt-2 font-weight-bold text-center ">Terjual</div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 text-center">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <a href="profile.php">
                                        <i class="fas fa-share-alt fa-5x" style="color: rgb(0, 59, 236);"></i>
                                    </a>
                                    <div class="mt-2 font-weight-bold text-center ">Kirim</div>
                                </div>
                            </div>
                        </div>

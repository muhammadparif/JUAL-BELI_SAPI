...
<head>
    ...
    <link rel="shortcut icon" href="img/logo_sapi.png" type="image/x-icon">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="index2.php">
                <div class="sidebar-brand-icon rotate-n-15">
                    <img src="img/logo_sapi.png" class="img-thumbnail rounded-circle" alt="">
                </div>
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-4">
                            <div class="card">
                                <i class="fas fa-user-circle fa-10x mx-auto mt-3"></i>
                                <!-- <img src="img/fotoku.jpg" style="width: 200px;height: 200px;" class="img-thumbnail rounded-circle rounded mx-auto d-block mt-4" alt="Profile"> -->
                            ...
                            <div class="card text-center">
                                <div class="card-header">
                                    <ul class="nav nav-tabs card-header-tabs">
                                        ...
                                        <li class="nav-item">
                                            <a class="nav-link active" aria-current="true" href="#">Edit Profile</a>
                                        </li>
                                        <li class="nav-item">

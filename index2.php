        ...
        <li class="nav-item">
          ...
          >
            <div class="bg-white py-2 collapse-inner rounded">
              ...
              <a class="collapse-item" href="login.php"> <i class="fas fa-user mx-2"></i> Pembeli</a>
            </div>
          </div>
        </li> -->
                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 col-md-4 col-lg-3 text-center">
                            <div class="card mb-3">
                                <div class="card-body">
                                    <i class="fas fa-thumbs-up fa-5x" style="color: rgb(0, 59, 236);"></i>
                                    <div class="mt-2 font-weight-bold text-center ">Rekomendasi</div>
                                </div>
                            </div>
                        </div>
